...
# Helper direkt laden (kein FUNCTIONS_FILE_PATH nötig)
source <(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/helpers/common.sh)
...
# --- HIER Version auf 0.15.2 umgestellt ---
msg_info "Installing Frigate v0.15.2"
cd ~
